function shpData = parse_polygon_m(fid, shxInfo, selection)
%PARSE_POLYGON_M Parses PolygonM-type shaperecords
...
%   See: <a href="matlab:help('migtap.shapefiles.read')">read</a>
    ...
    for k = 1:numRecs
        ...
        if shpType == 0
            shpData(k).ShapeType = 'NullPolygonM';
        elseif shpType == 25
            shpData(k).ShapeType = 'PolygonM';
            ...
            error('SHPREAD:InvalidShapeType', ...
                  ['Expected ShapeType 0 (Null) or 25 (PolygonM), ' ...
                   'got ''%d'' instead'], ...
                  shpType)
        end
    end
